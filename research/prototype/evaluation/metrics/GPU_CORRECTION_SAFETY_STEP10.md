...
pooled, per this project's established methodology (`../ablation/ABLATION_RESULTS.md`
§ correction funnel).
...
Source: `actual_outputs/gpu_capability_check/run_modeC_n5.jsonl`.
...
Source: `actual_outputs/gpu_correction_rerun/labeled_correction_validation_gpu_metrics.fresh.json`.
