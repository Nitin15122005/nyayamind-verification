...
Drawn from `../inputs/README.md` (its "Master Input Reference" and "Plain-Language
Summary" sections — originally two separate files, `INPUT_MANIFEST.md` and
`INPUT_SUMMARY.md`, merged during the PASS 1 cleanup) — no dataset
...
against a known-correct answer. See `../inputs/README.md`'s "METRIC-ONLY Inputs" section
(STEP 3, originally `inputs/metric_only/README.md` before the PASS 1 merge) and
