...
See gold_benchmark_common.py's module docstring for why that script itself cannot be imported
...
Writes ONLY under research/prototype/evaluation/ — never to research/prototype/outputs/.

Usage:
    research/.venv/Scripts/python.exe research/prototype/evaluation/scripts/run_gold01_evaluation.py
"""
