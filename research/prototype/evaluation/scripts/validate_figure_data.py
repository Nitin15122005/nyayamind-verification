...
Verifies the 11 files under research/prototype/evaluation/metrics/figure_data/ satisfy
...
Run from the repo root:
    research/.venv/Scripts/python.exe research/prototype/evaluation/scripts/validate_figure_data.py
"""
...
def check_numeric_values_match_source():
    ...
    paired209 = json.loads((TESTING_DIR / "actual_outputs" / "natural_data_runs" / "209_paired" / "paired_209_metrics.json").read_text(encoding="utf-8"))
...
def check_headline_reconciliation():
    ...
    ablation = json.loads((ABLATION_DIR / "ABLATION_SUMMARY.json").read_text(encoding="utf-8"))
