...
OUT_DIR = TESTING_DIR / "actual_outputs" / "natural_data_runs" / "209_paired"
...
def main() -> int:
    ...
    run_meta = {
        ...
        "command_executed": "research/.venv/Scripts/python.exe research/prototype/evaluation/scripts/run_natural_209_paired_evaluation.py",
