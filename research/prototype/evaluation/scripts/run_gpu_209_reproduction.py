...
pipeline behavior:
  ...
  1. Fresh outputs are written under
     research/prototype/evaluation/actual_outputs/gpu_209_reproduction/
...
_TESTING_DIR = Path(__file__).resolve().parent.parent  # PASS 3A: scripts moved into scripts/, one level deeper
...
def main() -> int:
    ...
    args = ap.parse_args()
    exact_command = "research/.venv/Scripts/python.exe research/prototype/evaluation/scripts/run_gpu_209_reproduction.py " + " ".join(sys.argv[1:])
    ...
    write_outputs = _TESTING_DIR / "actual_outputs" / "gpu_209_reproduction"
