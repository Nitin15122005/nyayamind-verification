...
research/prototype/evaluation/metrics/.
"""
...
ABLATION_DIR = TESTING_DIR / "ablation"  # PASS 1 cleanup: ABLATION_* files live here, not EVAL_DIR
FIG_DIR = EVAL_DIR / "figure_data"
FIG_DIR.mkdir(parents=True, exist_ok=True)

STEP4 = TESTING_DIR / "actual_outputs" / "gold_benchmark_runs"
STEP6 = TESTING_DIR / "actual_outputs" / "natural_data_runs"
...
ablation = load_json(ABLATION_DIR / "ABLATION_SUMMARY.json")
...
add_metric(
    ...
    source_artifact="evaluation/actual_outputs/gold_benchmark_runs/gold01_controlled/gold01_metrics.json",
...
add_metric(
    ...
    evidence_grade="A", source_artifact="evaluation/ablation/ABLATION_SUMMARY.json (factor=premise_framing)",
...
add_metric(
    ...
    fresh_or_historical="FRESH (STEP 4)", metric_class="gold_metric", evidence_grade="A",
    source_artifact="evaluation/actual_outputs/gold_benchmark_runs/gold02_synthetic/gold02_metrics.json",
...
add_metric(
    ...
    source_artifact="evaluation/actual_outputs/natural_data_runs/209_paired/paired_209_metrics.json",
...
add_metric(
    ...
    source_artifact="evaluation/actual_outputs/natural_data_runs/588_claims/claims_588_metrics.json",
...
add_metric(
    ...
    source_artifact="evaluation/ablation/ABLATION_SUMMARY.json (factor=claim_parser_fix)",
...
add_metric(
    ...
    evidence_grade=None, source_artifact="evaluation/components/run_metadata.json (full_suite_result); evaluation/PROVENANCE.md STEP 7 section",
...
add_metric(
    ...
    source_artifact="evaluation/ablation/scope_check_replay_fresh.json",
...
comp_rows = [
    {"component": "01_claim_parser", "tests": 111, "passed": 111, "real_model_used": "No", "cpu_gpu": "CPU",
     ...
     "classification": "SOFTWARE BEHAVIOR PASS", "source_artifact": "evaluation/components/01_claim_parser/"},
    {"component": "02_evidence_matcher", "tests": 72, "passed": 72, "real_model_used": "No", "cpu_gpu": "CPU",
     ...
     "classification": "SOFTWARE BEHAVIOR PASS", "source_artifact": "evaluation/components/02_evidence_retrieval/"},
    {"component": "03_verifier", "tests": 48, "passed": 48, "real_model_used": "Yes (DeBERTa)", "cpu_gpu": "CPU",
     ...
     "classification": "SOFTWARE BEHAVIOR PASS", "source_artifact": "evaluation/components/03_nli_verification/"},
    {"component": "04_verdict_application", "tests": 3, "passed": 3, "real_model_used": "No (mocked)", "cpu_gpu": "CPU",
     ...
     "source_artifact": "evaluation/components/04_verdict_application/"},
    {"component": "05_citation_adversarial", "tests": 15, "passed": 15, "real_model_used": "No", "cpu_gpu": "CPU",
     ...
     "source_artifact": "evaluation/components/02_evidence_retrieval/ (citation_adversarial_demo_examples.json)"},
    {"component": "06_correction_safety", "tests": 35, "passed": 35, "real_model_used": "Yes (DeBERTa, 3 of 35)", "cpu_gpu": "CPU",
     ...
     "source_artifact": "evaluation/components/06_scope_safety/"},
    {"component": "07_final_assembly", "tests": 5, "passed": 5, "real_model_used": "Yes (DeBERTa, 3 of 5)", "cpu_gpu": "CPU",
     ...
     "classification": "SOFTWARE BEHAVIOR PASS", "source_artifact": "evaluation/components/08_final_assembly/"},
]
