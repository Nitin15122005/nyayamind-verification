...
OUT_DIR = TESTING_DIR / "metrics" / "input_integrity"  # PASS 3A: inner evaluation/ renamed to metrics/
OUT_DIR.mkdir(parents=True, exist_ok=True)

# Files with a hash already recorded in STEP 3 (evaluation/MANIFEST.md / inputs/README.md)
