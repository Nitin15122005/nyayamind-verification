...
Run from the repo root:
    research/.venv/Scripts/python.exe research/prototype/evaluation/scripts/validate_gpu_experiments.py
"""
...
STEP10_VALIDATION_DIR = TESTING_DIR / "actual_outputs" / "gpu_capability_check"
STEP10_EXPERIMENTS_DIR = TESTING_DIR / "actual_outputs" / "gpu_correction_rerun"
