...
Run from the repo root:
    research/.venv/Scripts/python.exe research/prototype/evaluation/scripts/validate_figures.py
"""
...
DATA_DIR = TESTING_DIR / "metrics" / "figure_data"  # PASS 3A: inner evaluation/ renamed to metrics/
