...
`../../comparisons/metric_based/` — not established by these tests.
...
- `scripts/measure_evidence_coverage_v0_vs_v1.py` — v0-vs-v1 coverage measurement (feeds
  `../../comparisons/metric_based/`, not a test itself).
