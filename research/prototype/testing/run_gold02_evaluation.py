...
destination differs: outputs go under testing/, never overwriting
...
Usage:
    research/.venv/Scripts/python.exe research/prototype/testing/run_gold02_evaluation.py
"""
...
def main() -> int:
    ...
    run_meta = {
        ...
        "command_executed": "research/.venv/Scripts/python.exe research/prototype/testing/run_gold02_evaluation.py",
