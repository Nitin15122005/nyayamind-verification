...
Independent, re-runnable checks over the whole research/prototype/testing/ workspace
...
Run from the repo root:
    research/.venv/Scripts/python.exe research/prototype/testing/validate_step13_release_audit.py
"""
...
REQUIRED_DIRS = [
    ...
    "component_tests", "integration_tests", "ablation", "evaluation",
    "figures", "reports",
]
...
def _resolves(rel: str) -> bool:
    ...
    candidates = [
        TESTING_DIR / rel,
        TESTING_DIR / rel.removeprefix("testing/"),
        PROTOTYPE_DIR / rel,
...
def check_figures_exist():
    name = "All 11 figures exist under testing/figures/"
