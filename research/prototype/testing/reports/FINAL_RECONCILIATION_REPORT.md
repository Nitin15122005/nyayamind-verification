...
| STEP 3 | `inputs/INPUT_MANIFEST.md`, `actual_outputs/step3_input_validation/validate_inputs_report.txt` | 38/38 input-integrity checks; GOLD-01 n=420, GOLD-02 n=59, hashes verified |
...
| STEP 5 | `actual_outputs/step5_components/`, `evaluation/COMPONENT_TEST_MATRIX.csv` | 205/205 full suite; 7 component groups, 0 failures |
...
| STEP 7 | `evaluation/ABLATION_SUMMARY.json`, `ABLATION_EVIDENCE_GRADES.md` | 9 levers graded A-E; joint four-lever confirmed absent |
