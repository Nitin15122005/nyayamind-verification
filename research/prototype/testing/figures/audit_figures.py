...
Run from the repo root:
    research/.venv/Scripts/python.exe research/prototype/testing/figures/audit_figures.py
"""
        ...
        if fname not in metadata:
            ...
            if source_artifact:
                ...
                for part in source_artifact.split(";"):
                    part = part.strip()
                    candidates = [
                        TESTING_DIR / "actual_outputs" / part.replace("step4/", "step4_gold_verifier/").replace("step6/", "step6_natural_data/"),
