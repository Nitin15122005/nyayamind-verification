...
Every plotted value is read directly from research/prototype/testing/evaluation/figure_data/*.csv
...
Usage:
    research/.venv/Scripts/python.exe research/prototype/testing/figures/generate_figures.py
"""
