const STYLES = {
  ...
  NO_EVIDENCE: "bg-white/5 text-ink-secondary border-white/15",
};
...
export default function VerdictBadge({ verdict, confidence }) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-2 rounded-full border px-3.5 py-1.5 font-mono text-sm font-semibold tracking-wide ${cls}`}
    >
